    ...
    <div class="box-tab m-b-0" id="rootwizard">
      <ul class="wizard-tabs">
        ...
        <li style="width:100%;"> <a data-toggle="" style="text-align:right">
          <button type="button" class="btn btn-primary btn-icon" onclick="save_multiple_post('form_data|tblkemasanrepo'); return false;">Save <i class="icon-check"></i></button>
          </a> </li>
      </ul>
            ...
            <div class="col-md-12">
              <form name="form_data" id="form_data" class="form-horizontal" role="form" action="<?php echo site_url('plp/execute/'.$act.'/pengajuan/'.$ID); ?>" method="post" autocomplete="off" onsubmit="save_post('form_data'); return false;">
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <div class="input-prepend input-group"><span class="add-on input-group-addon"><i class="icon-calendar"></i></span>
                      <input class="form-control drp" type="text" placeholder="TANGGAL SURAT" name="DATA[TGL_SURAT]" id="TGL_SURAT" readonly="readonly"  data-provide="datepicker" wajib="yes" value="<?php echo $arrhdr['TGL_SURAT']; ?>">
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label-left">KODE GUDANG ASAL</label>
                  <div class="col-sm-2">
                  	<input type="hidden" name="DATA[KD_TPS_ASAL]" id="KD_TPS_TUJUAN" wajib="yes" value="<?php echo $arrhdr['KD_TPS_ASAL']; ?>" readonly="readonly">
                    <input type="text" readonly = "readonly" name="DATA[KD_GUDANG_ASAL]" id="KD_GUDANG_TUJUAN" wajib="yes" class="form-control" placeholder="KODE GUDANG ASAL" value="<?php echo $arrhdr['KD_GUDANG_ASAL']; ?>">
                  </div>
                  <div class="col-sm-7">
                    <input type="text" name="GUDANG_ASAL" id="GUDANG_TUJUAN" readonly = "readonly" wajib="yes" class="form-control" placeholder="NAMA GUDANG ASAL" value="<?php echo $arrhdr['GUDANG_ASAL']; ?>">
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <textarea name="NAMA_ALASAN_PLP" id="NAMA_ALASAN_PLP" class="form-control" placeholder="ALASAN PLP" ><?php echo $arrhdr['ALASAN_PLP']; ?></textarea>
                  </div>
                  <input type="hidden" name="DATA[KD_ALASAN_PLP]" id="KD_ALASAN_PLP" wajib="yes" class="form-control" placeholder="KD ALASAN PLP" value="<?php echo $arrhdr['KD_ALASAN_PLP']; ?>">
                  <div class="col-sm-1" style="padding-top:2px">
