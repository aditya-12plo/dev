  ...
  <div class="card-block p-a-0">
    <div class="box-tab m-b-0" id="rootwizard">
      <ul class="wizard-tabs">
        <li class="active"><a href="#tab_batal" data-toggle="tab">DATA RESPON BATAL PLP TUJUAN</a></li>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card bg-white">
                <div class="card-header">DATA RESPON BATAL PLP TUJUAN</div>
                <div class="card-block p-a-0">
