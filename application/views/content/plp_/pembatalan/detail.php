  ...
  <div class="card-block p-a-0">
    <div class="box-tab m-b-0" id="rootwizard">
      <ul class="wizard-tabs">
        <li class="active"><a href="#tab_batal" data-toggle="tab">DATA PEMBATALAN PLP</a></li>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card bg-white">
                <div class="card-header">DATA REQUEST PEMBATALAN PLP</div>
                <div class="card-block p-a-0">
                  <div class="table-responsive">
                    <table class="table m-b-0">
                      <tbody>
                        ...
                        <tr>
                          <th>GUDANG</th>
                          <td><?php echo $arrhdr['GUDANG']." [".$arrhdr['KD_GUDANG']."]" ?></td>
                        </tr>
                        <tr>
                          <th>NAMA PEMOHON</th>
                          <td><?php echo $arrhdr['NM_PEMOHON']; ?></td>
                        </tr>
                        <tr>
                          <th>ALASAN</th>
                          <td><?php echo $arrhdr['ALASAN']; ?></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
