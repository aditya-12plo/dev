...
<head>
	<meta charset="UTF-8">
	<title>CFS CENTER [ERROR:PHP]</title>
...
<body>
	<p class="main_head"><?php echo $severity."\n"; ?></p>
	<p class="sub_head"><?php echo $message; ?></p>
    <p class="sub_head"><?php echo $filepath; ?></p>
    <p class="sub_head"><?php echo $line; ?></p>
	<p class="sub_head">Go to <a href="<?php echo $config['base_url']."index.php"; ?>">dashboard</a></p>
</body>
</html>