    ...
    if ($Query->size() > 0) {
        while ($Query->next()) {
			...
			/*$xml = '<soapenv:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ser="http://services.beacukai.go.id/">
				   <soapenv:Header/>
				   <soapenv:Body>
					  <ser:UploadBatalPLP soapenv:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/">
            ...
            if ($Send['response'] != '') {
				...
				//$arr1 = 'ns1:UploadBatalPLPResponse';
			...
			$SQL = "UPDATE t_request_batal_plp_hdr SET KD_STATUS = '".$STATUS_HDR."', TGL_STATUS = NOW()
