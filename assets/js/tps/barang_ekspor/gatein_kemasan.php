    ...
    <div class="box-tab m-b-0" id="rootwizard">
      <ul class="wizard-tabs">
        ...
        <li style="width:100%;"> <a data-toggle="" style="text-align:right"> 
          <button type="button" class="btn btn-primary btn-icon" onclick="save_popup('frm_data','divtblkemasan'); return false;">GATE IN <i class="icon-check"></i></button>
          </a> </li>
      </ul>
      <div class="tab-content">
        <div class="row">
          <div class="tab-pane p-x-lg active" id="gatein">
            <form name="frm_data" id="frm_data" class="form-horizontal" role="form" action="<?php echo site_url('tps/execute/'.$exec.'/barang_ekspor-gatein_kemasan/'.$ID); ?>" method="post" autocomplete="off" onsubmit="save_popup('frm_data','divtblkemasan'); return false;">
              <div class="col-md-6">
