  ...
  <div class="card-block p-a-0">
    <div class="box-tab m-b-0" id="rootwizard">
      <ul class="wizard-tabs">
        ...
        <li><a href="#gateout" data-toggle="tab">LOADING</a></li>
        <li style="width:100%;"> <a data-toggle="" style="text-align:right">
          <button type="button" class="btn btn-primary btn-icon" onclick="save_popup('frm_loading','tblkemasan'); return false;">LOADING<i class="icon-check"></i></button>
          </a></li>
      </ul>
      <div class="tab-content">
        <div class="tab-pane p-x-lg active" id="gatein">
          <form name="frm_gatein" id="frm_gatein" class="form-horizontal" role="form">
            <div class="row">
              <div class="col-md-6">
        ...
        <div class="tab-pane p-x-lg" id="gateout">
          <form name="frm_loading" id="frm_loading" class="form-horizontal" role="form" action="<?php echo site_url('tps/execute/update/barang_ekspor-loading_kemasan/'.$ID); ?>" method="post" autocomplete="off" onsubmit="save_popup('frm_loading','tblkemasan'); return false;">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label class="col-sm-3 control-label-left">JENIS DOKUMEN</label>
              ...
              <div class="col-md-6">
                ...
                <?php //if(set_setting('SETWKINOUT') == 'Y'): ?>
                <div class="form-group">
                  <label class="col-sm-3 control-label-left">LOADING</label>
                  <div class="col-sm-9">
                    <div class="input-prepend input-group"><span class="add-on input-group-addon"><i class="icon-calendar"></i></span>
