    ...
    <div class="box-tab m-b-0" id="rootwizard">
      ...
      <div class="tab-content">
        <div class="tab-pane p-x-lg active" id="tab1">
          <form name="form_data" id="form_data" class="form-horizontal" role="form" action="<?php echo site_url('tps/execute/save/gate_in'); ?>" method="post" autocomplete="off" onsubmit="save_post('form_data'); return false;">
