  ...
  <div class="card-block p-a-0">
    <div class="box-tab m-b-0" id="rootwizard">
      <ul class="wizard-tabs">
        <li class="active"><a href="#tab1" data-toggle="tab">DISCHARGE</a></li>
        <?php if($act=="detail"): ?>
        <!--<li><a href="#tab2" data-toggle="tab">KONTAINER</a></li>-->
        <li><a href="#tab3" data-toggle="tab">KEMASAN</a></li>
        <?php endif; ?>
      ...
      <div class="tab-content">
        <div class="tab-pane p-x-lg active" id="tab1">
          <form name="form_data" id="form_data" class="form-horizontal" role="form" action="<?php echo site_url('tps/execute/save/bongkaran_kapal-discharge/'.$ID); ?>" method="post" autocomplete="off" onsubmit="save_post('form_data'); return false;">
        ...
        <?php if($act=="detail"): ?>
        <?php /*?><div class="tab-pane p-x-lg" id="tab2">
        	<?php echo $table_kontainer; ?>
        </div><?php */?>
        <div class="tab-pane p-x-lg" id="tab3"> <?php echo $table_kemasan; ?> </div>
        <?php endif; ?>
      </div>
    </div>
  </div>
