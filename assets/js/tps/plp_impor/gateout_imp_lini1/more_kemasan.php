  ...
  <div class="card-block p-a-0">
    <div class="box-tab m-b-0" id="rootwizard">
      <ul class="wizard-tabs">
        <li class="active"><a href="#tab_loading" data-toggle="tab">DATA GATEOUT</a></li>
        <li><a href="#tab_kemasan" data-toggle="tab">DATA KEMASAN</a></li>
        <li style="width:100%;"> <a data-toggle="" style="text-align:right">
          <button type="button" class="btn btn-primary btn-icon" onclick="save_popup('frm_kemasan','divtblkemasan'); return false;">GATEOUT <i class="icon-check"></i></button>
          </a> </li>
      </ul>
      <div class="tab-content">
        <div class="tab-pane p-x-lg active" id="tab_loading">
          <form name="frm_kemasan" id="frm_kemasan" class="form-horizontal" role="form" action="<?php echo site_url('gate/execute/update/more_out_imp_lini_1-kms/'.$ID); ?>" method="post" autocomplete="off" onsubmit="save_popup('frm_kemasan','divtblkemasan'); return false;">
            <div class="row">
              <div class="col-md-6">
            ...
            <input type="hidden" name="seri" id="seri" readonly="readonly" value="<?php echo $seri; ?>" />
            </form>
        </div>
        <div class="tab-pane" id="tab_kemasan">
        	<?php echo $table_kemasan_more; ?>
        </div>
      </div>
    </div>
  </div>
