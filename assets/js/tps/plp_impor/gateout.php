  ...
  <div class="card-block p-a-0">
    <div class="box-tab m-b-0" id="rootwizard">
      <ul class="wizard-tabs">
        <li class="active"><a href="#tab1" data-toggle="tab">GATE OUT</a></li>
      ...
      <div class="tab-content">
        <div class="tab-pane p-x-lg active" id="tab1">
          <form name="form_gateout" id="form_gateout" class="form-horizontal" role="form" action="<?php echo site_url('tps/execute/save/gate_in'); ?>" method="post" autocomplete="off" onsubmit="save_multiple_post('form_gateout|tblkemasan'); return false;">
