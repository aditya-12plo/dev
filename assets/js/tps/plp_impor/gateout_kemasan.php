  ...
  <div class="card-block p-a-0">
    <div class="box-tab m-b-0" id="rootwizard">
      <ul class="wizard-tabs">
        ...
        <?php if($act=="edit_kemasan"): ?>
          <button type="button" class="btn btn-primary btn-icon" onclick="save_popup('frm_gateout','tblkemasan'); return false;">GATE OUT<i class="icon-check"></i></button>
        <?php endif; ?>
          </a></li>
      </ul>
      <div class="tab-content">
        ...
        <div class="tab-pane p-x-lg" id="gateout">
          <form name="frm_gateout" id="frm_gateout" class="form-horizontal" role="form" action="<?php echo site_url('tps/execute/update/gate_out/'.$ID); ?>" method="post" autocomplete="off" onsubmit="save_popup('frm_gateout|tblkemasan'); return false;">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label class="col-sm-3 control-label-left">JENIS DOKUMEN</label>
